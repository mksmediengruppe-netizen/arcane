...
// PHASE-6: File attachment from agent message(type="result", attachments=[...])
...
export const PROJECTS: Project[] = [
  ...
  { id: "p5", name: "Arcane Audit", type: "Internal", chatCount: 2, lastActivity: "неделю назад", color: "#DC2626" },
];
