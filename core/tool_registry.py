...
TOOLS: list[dict] = [
    ...
    _tool("image_generate",
        ...
        "- For landing pages: generate 5-7 UNIQUE images BEFORE writing HTML. Each MUST have a DIFFERENT subject\n"
        "- MANDATORY: hero (wide), about (team/process), gallery x3 (different products/angles), feature (detail), CTA (background)\n"
        "- NEVER generate two images with the same subject or composition\n"
        "- ALL generated images MUST be used in the final HTML. Do NOT skip any\n"
        "- Do NOT use Unsplash URLs (images.unsplash.com) for key visuals — use this for custom illustrations/graphics\n"
